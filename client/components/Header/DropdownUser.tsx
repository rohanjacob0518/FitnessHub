  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="h-26 w-12 rounded-full">
          {/* <img src="https://i.pinimg.com/736x/50/3d/5e/503d5e8734cabc0ee4196cae1602bcb8.jpg" alt="user" 
            style={{
              width: "auto",
              height: "50px",
              borderRadius:"30px"
          ...
          /> */}
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="26" fill="currentColor" className="bi bi-person-lines-fill" viewBox="0 0 16 16"
          style={{
            width: "auto",
            height: "50px",
            borderRadius:"30px"
      ...
      <div
        ...
        className={`absolute right-2 mt-8 flex w-62.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
          dropdownOpen === true ? "block" : "hidden"
        }`}
        // style={{position:"relative"}}
      >
        <ul className="flex flex-col gap-5 border-b border-stroke px-9 py-8 dark:border-strokedark">
        <li>
            <Link
              href="/userdash"
              className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-house-door" viewBox="0 0 22 22">
        ...
        <button className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base" onClick={() => router.push("/login")}>
          <svg
            className="fill-current"
            width="22"
            height="22"
