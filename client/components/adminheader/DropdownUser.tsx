...
const DropdownUser = () => {
  ...
  useEffect(()=>{
    ...
    axios.get('http://localhost:9900/admintoke').then(res=>{
      if(res.data.Status === "Success"){
        setAdminName(res.data.adname)
      } else {
...
{/* 
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="50px" fill="currentColor" className="bi bi-file-earmark-person" viewBox="0 0 16 16">
      ...
      <div
        ...
        className={`absolute right-0 mt-6 flex w-82.5 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${
      ...
      >
        ...
        <button className="flex items-center gap-3.5 px-6 py-4 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base" onClick={() => router.push("/adminlogin")}>
          <svg
            className="fill-current"
            width="22"
            height="22"
